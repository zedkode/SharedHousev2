...
- Description: Single-page administration shell with masthead, hero, environment status and
  foundation cards.
...
There is no mobile layout implementation yet. The planned mobile shell uses five stable
destinations: Home, Calendar, Money, Tasks and House.
